...
public interface AnimationBuilder<Doc> {
   ...
   * @param g1   The initial green color-value of the shape
   * @param b1   The initial blue color-value of the shape
   * @param theta1 The initial angle of the shape in degrees
   * @param t2   The end time of this transformation
   * @param x2   The final x-position of the shape
   * @param y2   The final y-position of the shape
   * @param w2   The final width of the shape
   ...
   * @param g2   The final green color-value of the shape
   * @param b2   The final blue color-value of the shape
   * @param theta2 The final angle of the shape in degrees
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addMotion(String name,
                                  int t1, int x1, int y1, int w1, int h1, int r1, int g1, int b1,
                                  int theta1, int t2, int x2, int y2, int w2, int h2, int r2,
                                  int g2, int b2, int theta2);
   ...
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addKeyframe(String name, int t, int x, int y, int w,
   ...
   * @param g    The green color-value of the shape
   * @param b    The blue color-value of the shape
   * @param theta The angle of the shape in degrees
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addKeyframe(String name, int t, int x, int y, int w,
                                    int h, int r, int g, int b, int theta);
