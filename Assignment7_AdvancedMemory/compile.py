...
os.system('gcc -pthread tests/pthread.c -o tests/pthread')
...
os.system('valgrind ./tests/pthread')

# Compile our malloc program
os.system('clang -pthread -c mymalloc.c')
...
os.system('gcc -pthread -I. -o ./tests/pthread_mymalloc ./tests/pthread.c mymalloc.o')
